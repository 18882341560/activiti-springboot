 ...
 * @description: 类描述:
 **/
public class FangfaProcessDiagramGenerator extends DefaultProcessDiagramGenerator {
    ...
    protected static DefaultProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        return new FangfaProcessDiagramCanvas((int) maxX + 10,(int) maxY + 10, (int) minX, (int) minY,
