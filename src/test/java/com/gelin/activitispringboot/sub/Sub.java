package com.gelin.activitispringboot.sub;
...
public class Sub {
    ...
    public void deploySimpleProcessDefinition() {
        Deployment deploy = repositoryService.createDeployment()
                .name("子流程")
                .addClasspathResource("processes/subprocess/sub.bpmn")
                .deploy();
    ...
    public void startProcess(){
        ProcessInstance helloworld = runtimeService.startProcessInstanceByKey("subProcess");// 使用 key 来启动好处 默认寻找最新版本，版本多了的话
    }

    @Test
    public void findMyTask(){
        List<Task> taskList = taskService.createTaskQuery() // 创建人物查询对象
                                         .taskCandidateUser("葛林1") //指定个人任务查询
                                         .list();
