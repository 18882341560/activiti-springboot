package com.gelin.activitispringboot.call;
...
public class Call {
    ...
    public void deploySimpleProcessDefinition() {
        Deployment deploy = repositoryService.createDeployment()
                .name("子流程")
                .addClasspathResource("processes/call/call.bpmn")
                .deploy();
    ...
    public void startProcess(){
        ProcessInstance helloworld = runtimeService.startProcessInstanceByKey("callProcess");// 使用 key 来启动好处 默认寻找最新版本，版本多了的话
    }
